		...
		<form action="dynamic_set.jsp" name="frm" id="frm" method="post">
			<table>
				<tr>
					...
					<td>
						<input data-value="아이디를 입력해주세요." value="${ param.id }" readonly="readonly" name="id" id="id" class="inputTxt inputIdtype" type="text" maxlength="20"  />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input data-value="이름을 입력해주세요." value="${ wmd.name }" name="name" class="inputTxt inputName" type="text"  />
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="">생일</label></th>
					<td >
						<input type="text" value="${ wmd.birth }" name="birthday" id="birthday" data-value="생년월일을 입력해 주세요."/>
					</td>
				</tr>
				<tr>
					<th>휴대폰</th>
				...
				<tr>
					<th><label for="gender">성별</label></th>
 					<td> 
						<input data-value="성별을 선택하세요."${ wmd.gender eq '1' ? "checked='checked'" : ""} name="gender" type="radio" id="radio_check01" value="1" />
						<label for="radio_check01">남자</label>
 						<input name="gender"${ wmd.gender eq '2' ? "checked='checked'" : "" } type="radio" id="radio_check02"  value="2"/>
...
<!-- 						<input  id="area" name="area" class="inputTxt inputName" type="text" /> -->
				...
				<tr>
					<td>가입일 / ip</td>
					<td>
					<input type="text" class="inputBox" value="${ wmd.input_date } / ${ wmd.ip }" readonly="readonly" style="width: 270px"/>
					</td>
				</tr>
			</table>
